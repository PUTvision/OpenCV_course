...
static void MatricesAreFunPart1(void)
{
	Mat matrix;
...
static void MatricesAreFunPart2(void)
{
	Mat image = imread("resources//programmers_tan.jpg", IMREAD_GRAYSCALE);
	std::cout << std::endl << "Wczytany obraz piksel (0,  0):" << image.row(0).col(0) << std::endl;
}

static void MatricesAreFunPart3(void)
{
	std::cout << std::endl;
	Mat mat1, mat2;
